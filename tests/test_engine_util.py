...
class TestEngineUtil(unittest.TestCase):
    ...
    def test_bitboard_to_locations_0_0(self):
        bitboard_0_0 = int('1' + '0' * (N_FILES * N_RANKS - 1), 2)
    ...
    def test_bitboard_to_locations_3_4(self):
        bitboard_0_0 = int('0'*N_FILES*4 + '000010000' + (N_RANKS-5)*N_FILES*'0', 2)

        print(np.binary_repr(bitboard_0_0, width=90))

        self.assertEqual([(4, 4)], engine_util.bitboard_to_locations(bitboard_0_0))
